...
<head>
  ...
  .login{
   ...
   /* background-color: hsl(235deg 81% 83% / 92%)!important; */
  </style>  
</head>
...
<body class="h-screen font-sans login bg-cover">
        ...
        <div class="w-full max-w-lg">
            ...
            <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" form action="customerlogin" method="POST">
               <div class="alert  fade show {{!Session::get('incorrect') ? 'hidden' : ''}}">
                            <span class="close" data-dismiss="alert">×</span>
                            <strong style="text-align:center;background: #b3e6e6; color: red;">{{Session::get('incorrect')}}</strong>
                            <strong style="text-align:center;background: #b3e6e6; color: green;">{{Session::get('successfull')}}</strong>
