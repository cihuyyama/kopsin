	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
					...
					<div class="flexslider">
						...
						<ul class="slides">
							<li data-thumb="images/d2.jpg">
								<div class="thumb-image"> <img src="{{$posts->fPrice}}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
			...
			<div class="col-md-8 single-right-left simpleCart_shelfItem">
				<h3>{{$posts->fName}}</h3>
				<p><span class="item_price">{{$posts->fPrice}}</span>
					<del>$1,199</del>
				</p>
				<div class="rating1">
					<ul class="stars">
				...
				<div class="occasional">
					<h5>Types :</h5>
					<div class="colr ert">
						<label class="radio"><input type="radio" name="radio" checked=""><i></i>Coffee</label>
					</div>
					<div class="colr">
						<label class="radio"><input type="radio" name="radio"><i></i>Drinks </label>
					</div>
					<div class="colr">
