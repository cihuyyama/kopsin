		...
		<div class="wrapper_top_w3layouts">
			<div class="header_agileits">
				<div class="logo inner_page_log">
					<h1><a class="navbar-brand" href="index.html"><span>KOPI</span> <i>SINI</i></a></h1>
				</div>
		...
		<div class="shop_inner_inf">
			...
			<div class="inner_section_w3ls">
				<div class="col-md-6 news-left">
					...
					<img src="images/coffeeOff.jpg" alt="coffee" class="img-responsive">
				</div>
				
				<div class="style-image-1_info">
					<div class="style-grid-2-text_info">
					<h4>Welcome to our Coffee Shop</h4>
					<p class="sub_p">Our Coffee Shop, or café is an establishment that primarily serves coffee of various types,
									 e.g. espresso, latte, and cappuccino.
									 Coffeehouses range from owner-operated small businesses to large multinational corporations. 
						             Some coffeehouse chains operate on a franchise business model, with numerous branches across various countries around the world.
						 
					</p>
					<p>Our Coffee Shop also has two other section. Sancks And Drinks. As a Snacks we serve light food, sandwiches, muffins, fruit, or pastries. 
					In section of drinks we serve different types of of juice and soft drinks, such as iced coffee, iced tea, and other non-caffeinated beverages. 
				...
				<!-- <div class="col-md-6 news-right">
					<h4>Welcome to our Coffee Shop</h4>
					<p class="sub_p">Our coffee shop, or café is an establishment that primarily serves coffee of various types,
									 e.g. espresso, latte, and cappuccino. Some coffeehouses may serve cold drinks, such as iced coffee, iced tea, and other non-caffeinated beverages. 
									 In continental Europe, cafés serve alcoholic drinks.
						 
					</p>
					<p>Our Coffee Shop also has two other section. Sancks And Drinks. As a Snacks we serve food, such as light snacks, sandwiches, muffins, fruit, or pastries. 
						Coffeehouses range from owner-operated small businesses to large multinational corporations. 
						Some coffeehouse chains operate on a franchise business model, with numerous branches across various countries around the world.
					</p>
				</div> -->
